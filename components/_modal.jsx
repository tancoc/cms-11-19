...
const Modal = (props) => {
	...
	return (
		<>
			...
			<ChakraModal size={size} preserveScrollBarGap isOpen={disclosure.isOpen} onClose={disclosure.onClose} {...props}>
				<ModalOverlay />
				...
				<ModalContent>
					{(!header || header !== 'off') && (
						<ModalHeader display="flex" justifyContent="space-between" alignItems="center">
							...
							<IconButton size="sm" borderRadius="full" icon={<FiX size={16} />} onClick={disclosure.onClose} />
						</ModalHeader>
					)}
