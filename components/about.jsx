	...
	return (
		<chakra.section pt={100} id="about">
			<Flex direction="column" gap={12}>
				...
				<Stack direction={{ base: 'column-reverse', lg: 'row' }} align="center" spacing={12}>
					<Stack spacing={6} w="full">
						<Heading fontSize={{ base: 32, md: 48 }} fontWeight="semibold" textAlign={{ base: 'center', md: 'left' }} color="accent-1">
