			...
			<Flex align="center" gap={6} mx="auto" px={6} h={20} w="full" maxW={1280}>
				<Flex flex={1} justify="start" align="center">
					<Flex align="center" gap={2}>
						<Flex bg="brand.default" justify="center" align="center" h={8} w={10}>
							<Text fontSize="xl" fontWeight="semibold" color="white">
								JP
							</Text>
						</Flex>

						<Text display={{ base: 'none', md: 'block' }} fontSize="xl" fontWeight="semibold" color="accent-1">
							Dental Clinic.
						</Text>
					</Flex>
				</Flex>
					...
					{session && session.user.role === 'Admin' ? (
						<Flex align="center" gap={10}>
							...
							<NextLink href="/schedule" passHref>
								<Link as="span" active={router.pathname.includes('schedule') ? 1 : 0}>
									Schedule
								</Link>
							</NextLink>
							...
							<NextLink href="/patients" passHref>
								<Link as="span" active={router.pathname.includes('patients') ? 1 : 0}>
									Patients
								</Link>
							</NextLink>
				...
				<Flex flex={1} justify="end" align="center">
					<Flex align="center" gap={3}>
						...
						<Menu>
							<MenuButton as={IconButton} display={{ base: 'flex', lg: 'none' }} variant="outline" color="accent-1" icon={<FiMenu size={16} />} />
